...
function LateralBodyArt({ side }: { side: "left" | "right" }) { const mirror = side === "right"; return <G transform={mirror ? "translate(250 0) scale(-1 1)" : undefined}><Ellipse cx="125" cy="44" rx="25" ry="34" fill="#DCE9ED" /><Path d="M103 77 C101 84 94 90 86 97 L64 116 C58 134 63 181 82 218 L99 229 L140 229 L158 206 C171 178 173 132 165 113 L148 94 C141 87 140 81 140 76 Z" fill="#DCE9ED" /><Path d="M86 105 C63 111 45 137 39 170 L31 220 C31 228 37 233 45 231 L62 218 L74 163 L95 133 Z" fill="#DCE9ED" /><Path d="M98 222 L139 222 L148 340 C149 365 158 393 166 418 L142 418 C135 389 126 361 122 339 Z" fill="#DCE9ED" /><Path d="M141 411 L168 411 C181 417 187 429 184 438 L149 438 Z" fill="#DCE9ED" /><Path d="M103 118 Q125 132 148 117 M101 153 Q125 164 151 152 M103 184 Q125 194 150 183" stroke="#B9D0D6" strokeWidth="2" fill="none" /></G>; }
