...
const MAPPING = { "calendar": "calendar-month", "chart.bar.fill": "bar-chart", "checkmark.circle.fill": "check-circle", "chevron.right": "chevron-right", "cloud.sun.fill": "partly-cloudy", "heart.fill": "favorite", "house.fill": "home", "location.fill": "my-location", "plus": "add", "trash": "delete" } as const;
